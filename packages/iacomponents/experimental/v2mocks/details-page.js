...
export default class extends React.Component {
  static propTypes = {
    ...
    fullWidthTheatre: PropTypes.bool
  }
    ...
    return <div id="wrap" itemScope itemType="http://schema.org/AudioObject">
      ...
      <main id="maincontent">
        ...
        <div id="theatre-ia-wrap">
          ...
          <h1 className="sr-only">{this.props.itemTitle}</h1>
          <h2 className="sr-only">Audio Preview</h2>
           {/* className="container"*/}
          <div id="theatre-ia" >
          ...
          <div className="container container-ia">
            <div className="relative-row row">
              ...
              <div className="col-sm-4 thats-right item-details-archive-info">
                ...
                <MockCollectionsList collections={this.props.itemCollections}/>
