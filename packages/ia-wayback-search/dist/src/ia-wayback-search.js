...
let WaybackSearch = class WaybackSearch extends LitElement {
    constructor() {
        super(...arguments);
        this.queryHandler = {
            performQuery: (query) => (window.location.href = `https://web.archive.org/web/*/${query}`),
        };
        this.waybackPagesArchived = "916 billion";
    }
    render() {
        return html `
...
], WaybackSearch.prototype, "queryHandler", void 0);
__decorate([
    property({ type: String })
], WaybackSearch.prototype, "waybackPagesArchived", void 0);
__decorate([
    query("#url")
], WaybackSearch.prototype, "urlInput", void 0);
WaybackSearch = __decorate([
    customElement("ia-wayback-search")
], WaybackSearch);
export { WaybackSearch };
//# sourceMappingURL=ia-wayback-search.js.map