 ...
 */
class NavAboutsLI extends React.Component {
  render() {
    return (
 ...
 */
class NavAboutsUL extends React.Component {
  render() {
    return (
 ...
 */
class NavSearchLI extends React.Component {
  constructor(props) {
    super(props); // None
    this.state = {};
...
*/
class NavUploadLI extends React.Component {
  render() {
    return (
      this.props.disconnected ? null :
 ...
 */
class NavBrandLI extends React.Component {
  render() {
    return (
 ...
 */
class NavMediatypeLI extends React.Component {
  render() {
    return (
 ...
 *
 */
class NavWebDIV extends React.Component {
  /* not reqd if ref=load not used
  constructor(props) {
    super(props);
  ...
  */
  /*
  // Cant be right, there is no onLoad call
  load(el) {
  ...
  clickCallable() {
    ...
    return false;
    // This looks wrong, the old Jquery specific search was which would not appear to hide anything
 ...
 */
class DwebNavButtons extends React.Component {
  render() {
 ...
 */
class DwebStatusDIV extends React.Component {
  render() {
    // Alternative to complex nav-dweb code
...
export { NavWrap };
// Code Review Mitra 2019-12-06 except for HTML compare with archive.org
