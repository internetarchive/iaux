...
class AudioPlayerWithYoutubeSpotify extends Component {
    ...
    state = {
        albumData: flattenAlbumData(this.props.albumMetadata, this.props.playFullIAAudio),
        tracklistToShow: [],
    ...
    getSelectableChannels = () => {
        ...
        const channelOptions = channelsToDisplay.map((channel) => {
            ...
            return {
                value: channel,   //how about having label same as value?
                label: <Icon name={channel} />,
                clickTrackValue: `Audio-Player|Channel-${channel}`,
            };
        });

        return channelOptions;
    }
    displaytracknums(channel) {
    ...
    render() {
        ...
        const {
            title, itemPhoto, externalSources = [], identifier, collection, creator
        } = albumData;
            ...
            <div className="theatre__wrap audio-with-youtube-spotify">
                <section className="media-section">
                    <TheatreAudioPlayer
                        ...
                        customSourceLabel={<Icon name={channelToPlay} />}
                        linerNotes={null}
                ...
                <div className="grid-right">
                    ...
                    <section className="playlist-section">
                        <TheatreTrackList
                            ...
                            albumName={title[0]}
                            displayTrackNumbers={this.displaytracknums(channelToPlay)}
                            creator={creator[0]}
                            dataEventCategory="Audio-Player"
                        />
                    </section>
