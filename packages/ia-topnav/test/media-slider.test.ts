...
import { MediaSlider } from '../src/media-slider';
...
describe('<media-slider>', () => {
  ...
  it('renders a media subnav when texts selected', async () => {
    ...
    const menuHeading = mediaSlider.shadowRoot
      ?.querySelector('media-subnav[menu=texts]')
  ...
  it('renders a media subnav when audio selected', async () => {
    ...
    const menuHeading = mediaSlider.shadowRoot
      ?.querySelector('media-subnav[menu=audio]')
      ?.shadowRoot?.querySelector('h3');
  ...
  it('renders a media subnav when video selected', async () => {
    ...
    const menuHeading = mediaSlider.shadowRoot
      ?.querySelector('media-subnav[menu=video]')
      ?.shadowRoot?.querySelector('h3');
  ...
  it('renders the Wayback component when web menu selected', async () => {
    ...
    const waybackSearch = mediaSlider.shadowRoot
      ?.querySelector('media-subnav[menu=web]')
      ?.shadowRoot?.querySelector('wayback-search');
  ...
  it('renders the more links component when more menu selected', async () => {
    ...
    const moreSlider = mediaSlider.shadowRoot
      ?.querySelector('media-subnav[menu=more]')
      ?.shadowRoot?.querySelector('more-slider');
